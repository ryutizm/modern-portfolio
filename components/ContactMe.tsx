...
const ContactMe = (props: Props) => {
  ...
  return (
    <div
      className="
      flex relative flex-col my-28 pt-24 text-center md:text-left md:flex-row 
      max-w-7xl px-10 justify-evenly mx-auto items-center"
    >
      <h3 className="absolute ml-6 top-4 uppercase tracking-[20px] text-gray-500 text-2xl">
        Contact
      </h3>
